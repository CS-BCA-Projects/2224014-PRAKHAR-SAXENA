...
<body>
<br>
     <br><H1> <center>Welcome to  UPASTHITI <br> (Attendance System)</center> </H1>
     <div class="container" id="signIn">
        ...
        <form method="POST" action="">
            <div class="input-group">
                ...
                <select name="user_type" id="1" required>
            ...
            <a href="register.php" target="_blank">Open Registration Form</a>
